...
BEGIN
  ...
  INSERT INTO RoomType (type_name, base_price, capacity) VALUES ('ZZTEST-Std-02', 1000, 2)
  ...
  VALUES (v_branch, v_guest,'2026-09-01','2026-09-03',1) RETURNING reservation_id INTO v_res;
  ...
  BEGIN
    INSERT INTO Reservation (branch_id, guest_id, check_in_date, check_out_date, num_of_guests)
    VALUES (v_branch, v_guest,'2026-09-05','2026-09-05',1);
    v_ok := TRUE;
  ...
  BEGIN
    INSERT INTO Reservation (branch_id, guest_id, check_in_date, check_out_date, num_of_guests)
    VALUES (v_branch, v_guest,'2026-09-05','2026-09-06',0);
    v_ok := TRUE;
  EXCEPTION WHEN check_violation THEN
  ...
  v_ok := FALSE;
  INSERT INTO RoomAvailability (room_id, calendar_date, status) VALUES (v_room,'2026-09-01','Available');
  BEGIN
    INSERT INTO RoomAvailability (room_id, calendar_date, status) VALUES (v_room,'2026-09-01','Occupied');
    v_ok := TRUE;
  EXCEPTION WHEN unique_violation THEN
  ...
  BEGIN
    ...
    BEGIN
      INSERT INTO FacilityBooking (reservation_id, facility_id, start_date_time, end_date_time)
